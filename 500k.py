...
#chuong ngang 600x312
    ...
    for i in range(72, 102):
        ...
        obstacleY.append(i)
    for i in range(72, 102):
        obstacleX.append(240)
        obstacleY.append(i)

    for i in range(240, 310):
        obstacleX.append(i)
        obstacleY.append(72)
    for i in range(72, 102):
        obstacleX.append(240)
...
def main():
    ...
    s = [150, 120, np.deg2rad(0)]
    g = [205, 89, np.deg2rad(0)]
    ...
    for k in range(len(x)):
        ...
        plt.plot(obstacleX, obstacleY, "sk", markersize=3)
